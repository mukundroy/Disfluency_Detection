...
file_path = '/root/home_cdac/ICON/data/disfluency/Marathi/marathi_dev_postagged.tsv'
...
print(flat_f1_score(y, y_pred, average='weighted', labels=labels))
# Print classification report
report = flat_classification_report(y, y_pred)
print(report)

output_file_path = '/root/home_cdac/ICON/data/disfluency/Marathi/dev_test_output.txt'
...
with open(output_file_path, 'w', encoding='utf-8') as output_file:
    for i, sent_tags in enumerate(y_pred):
        ...
        for j, tag in enumerate(sent_tags):
            ...
            pos = X[i][j]['pos']
            disfluence = y[i][j]
            output_file.write(f"{word}\t{pos}\t{disfluence}\t{tag}\n")
