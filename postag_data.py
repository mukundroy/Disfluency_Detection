...
tagged_sentences = indian.tagged_sents('bangla.pos')
        ...
        with open(output_file, 'w', encoding='utf-8') as output:
            for line in file:
                ...
                if len(parts) >= 2:
                    ...
                    output.write(f"{parts[0]}\t{tagged_word[0][1]}\t{parts[1]}\n")
            output.write('\n')  # Ensure a blank line at the end if the input file ends without one

# Path to your CoNLL format file
input_file_path = '/root/home_cdac/ICON/data/disfluency/Marathi/marathi_dev.tsv'
# Path to the output file
output_file_path = '/root/home_cdac/ICON/data/disfluency/Marathi/marathi_dev_postagged.tsv'
